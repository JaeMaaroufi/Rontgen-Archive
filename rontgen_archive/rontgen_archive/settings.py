"""
Django settings for rontgen_archive project.
...
SECRET_KEY = 'django-insecure-v7q7ve$r3cn60ey2cc1xlytv%62(u=#k-m2s9(@sw9$xui*5mc'
...
ROOT_URLCONF = 'rontgen_archive.urls'
...
WSGI_APPLICATION = 'rontgen_archive.wsgi.application'
